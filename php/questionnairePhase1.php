...
$stmt->bind_param("ssssiiisssssssiissiisisss", $datePhase1, $_SESSION['nom'], $_SESSION['prenom'], $_SESSION['email'], $_SESSION['sujet'], $_SESSION['resultId'], $_SESSION['age'], $_SESSION['genre'], $_SESSION['etudes'], $_SESSION['filiere'], $_SESSION['langueMaternelle'], $_SESSION['langueX'], $empty, $datePhase2, $empty, $empty, $empty, $empty, $empty, $empty, $empty, $empty, $empty, $empty, $empty);
